...
class SpringReactiveMongodbcrudApplicationTests {
    ...
    public void addProductTest(){
		Mono<ProductDto> productDtoMono=Mono.just(new ProductDto("102","mobile",1,10000, null, null));
	...
	public void getProductsTest(){
		Flux<ProductDto> productDtoFlux=Flux.just(new ProductDto("102","mobile",1,10000, null, null),
				new ProductDto("103","TV",1,50000, null, null));
		...
		StepVerifier.create(responseBody)
				.expectSubscription()
				.expectNext(new ProductDto("102","mobile",1,10000, null, null))
				.expectNext(new ProductDto("103","TV",1,50000, null, null))
				.verifyComplete();
